...
uint32_t BufferCount = 0, TxCounter = 0, CEC_RxCounter = 0;
...
void HDMI_CEC_ProcessIRQSrc(void)
{
  ...
  { 
    ...
    else if(CEC_RxCounter == 1)   /* Receive opcode in the reception buffer */
    {
    ...
    {
      HDMI_CEC_RX_MessageStructPrivate.Operande[CEC_RxCounter-2] = CEC_ReceiveData();
      CEC_RxCounter++;
    }  
  ...
  {  
    if (CEC_RxCounter == 1)
    {
      ...
      HDMI_CEC_RX_MessageStructPrivate.RxMessageLength = CEC_RxCounter-1;
    } 
    else
    {
      HDMI_CEC_RX_MessageStructPrivate.RxMessageLength = CEC_RxCounter-2;
      ReceivedFrame = 1;
    }
