...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _ramp_6x6_Router167 0x00a8          /*signed 1.31 format*/
#define _select_0_6x6_Router167 0x00a9          /*signed integer*/
#define _select_1_6x6_Router167 0x00aa          /*signed integer*/
#define _select_2_6x6_Router167 0x00ab          /*signed integer*/
#define _select_3_6x6_Router167 0x00ac          /*signed integer*/
#define _select_4_6x6_Router167 0x00ad          /*signed integer*/
#define _select_5_6x6_Router167 0x00ae          /*signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Ls_Rs_Gain_1_1160 0x00af          /*signed integer*/
#define _ramp_Ls_Rs_Gain_1_1160 0x00b0          /*signed 1.31 format*/
#define _g_0_Ls_Rs_Gain_1_1160 0x00b1          /*signed 5.27 format*/
#define _g_1_Ls_Rs_Gain_1_1160 0x00b2          /*signed 5.27 format*/
#define _clip_0_Ls_Rs_Gain_1_1160 0x00b3          /*READ-ONLY: signed integer*/
#define _clip_1_Ls_Rs_Gain_1_1160 0x00b4          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Ls_Rs_Gain_2157 0x00b5          /*signed integer*/
#define _ramp_Ls_Rs_Gain_2157 0x00b6          /*signed 1.31 format*/
#define _g_0_Ls_Rs_Gain_2157 0x00b7          /*signed 5.27 format*/
#define _g_1_Ls_Rs_Gain_2157 0x00b8          /*signed 5.27 format*/
#define _clip_0_Ls_Rs_Gain_2157 0x00b9          /*READ-ONLY: signed integer*/
#define _clip_1_Ls_Rs_Gain_2157 0x00ba          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Ls_Rs_Gain_1156 0x00bb          /*signed integer*/
#define _ramp_Ls_Rs_Gain_1156 0x00bc          /*signed 1.31 format*/
#define _g_0_Ls_Rs_Gain_1156 0x00bd          /*signed 5.27 format*/
#define _g_1_Ls_Rs_Gain_1156 0x00be          /*signed 5.27 format*/
#define _clip_0_Ls_Rs_Gain_1156 0x00bf          /*READ-ONLY: signed integer*/
#define _clip_1_Ls_Rs_Gain_1156 0x00c0          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_L_R_Gain___24dB_114 0x00c1          /*signed integer*/
#define _ramp_L_R_Gain___24dB_114 0x00c2          /*signed 1.31 format*/
#define _g_0_L_R_Gain___24dB_114 0x00c3          /*signed 5.27 format*/
#define _g_1_L_R_Gain___24dB_114 0x00c4          /*signed 5.27 format*/
#define _clip_0_L_R_Gain___24dB_114 0x00c5          /*READ-ONLY: signed integer*/
#define _clip_1_L_R_Gain___24dB_114 0x00c6          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Subwoofer_Gain_1_1161 0x00c7          /*signed integer*/
#define _ramp_Subwoofer_Gain_1_1161 0x00c8          /*signed 1.31 format*/
#define _g_0_Subwoofer_Gain_1_1161 0x00c9          /*signed 5.27 format*/
#define _clip_0_Subwoofer_Gain_1_1161 0x00ca          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Subwoofer_Gain_2159 0x00cb          /*signed integer*/
#define _ramp_Subwoofer_Gain_2159 0x00cc          /*signed 1.31 format*/
#define _g_0_Subwoofer_Gain_2159 0x00cd          /*signed 5.27 format*/
#define _clip_0_Subwoofer_Gain_2159 0x00ce          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Subwoofer_Gain_1158 0x00cf          /*signed integer*/
#define _ramp_Subwoofer_Gain_1158 0x00d0          /*signed 1.31 format*/
#define _g_0_Subwoofer_Gain_1158 0x00d1          /*signed 5.27 format*/
#define _clip_0_Subwoofer_Gain_1158 0x00d2          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Center_Gain_2152 0x00d3          /*signed integer*/
#define _ramp_Center_Gain_2152 0x00d4          /*signed 1.31 format*/
#define _g_0_Center_Gain_2152 0x00d5          /*signed 5.27 format*/
#define _clip_0_Center_Gain_2152 0x00d6          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _threshold_Presence122 0x00d7          /*signed 1.31 format*/
#define _infinite_hold_Presence122 0x00d8          /*signed integer*/
#define _hold_count_Presence122 0x00d9          /*signed integer*/
#define _presence_Presence122 0x00da          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Center_Gain_1118 0x00db          /*signed integer*/
#define _ramp_Center_Gain_1118 0x00dc          /*signed 1.31 format*/
#define _g_0_Center_Gain_1118 0x00dd          /*signed 5.27 format*/
#define _clip_0_Center_Gain_1118 0x00de          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _threshold_Presence73 0x00df          /*signed 1.31 format*/
#define _infinite_hold_Presence73 0x00e0          /*signed integer*/
#define _hold_count_Presence73 0x00e1          /*signed integer*/
#define _presence_Presence73 0x00e2          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_SUB_Hard_Limiter106 0x00e3          /*signed integer*/
#define _tc_Peak_Square_Detector_SUB_Hard_Limiter106 0x00e4          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_SUB_Hard_Limiter106 0x00e5          /*READ-ONLY: signed 1.31 format*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_RS_Hard_Limiter102 0x00e6          /*signed integer*/
#define _tc_Peak_Square_Detector_RS_Hard_Limiter102 0x00e7          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_RS_Hard_Limiter102 0x00e8          /*READ-ONLY: signed 1.31 format*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_LS_Hard_Limiter98 0x00e9          /*signed integer*/
#define _tc_Peak_Square_Detector_LS_Hard_Limiter98 0x00ea          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_LS_Hard_Limiter98 0x00eb          /*READ-ONLY: signed 1.31 format*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_C_Hard_Limiter94 0x00ec          /*signed integer*/
#define _tc_Peak_Square_Detector_C_Hard_Limiter94 0x00ed          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_C_Hard_Limiter94 0x00ee          /*READ-ONLY: signed 1.31 format*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_R_Hard_Limiter90 0x00ef          /*signed integer*/
#define _tc_Peak_Square_Detector_R_Hard_Limiter90 0x00f0          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_R_Hard_Limiter90 0x00f1          /*READ-ONLY: signed 1.31 format*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_L_Hard_Limiter86 0x00f2          /*signed integer*/
#define _tc_Peak_Square_Detector_L_Hard_Limiter86 0x00f3          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_L_Hard_Limiter86 0x00f4          /*READ-ONLY: signed 1.31 format*/
