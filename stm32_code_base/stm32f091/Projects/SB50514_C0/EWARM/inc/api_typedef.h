...
#define DEFAULT_SRS_TRUVOL  1 /*Smith comment: Following UI 4.7 7.2.17 to modify default setting*/
#define DEFAULT_SRS_TSHD  1
#define DEFAULT_NIGHT_MODE 1 /*Smith comment: Following UI 4.7 7.2.17 to modify default setting*/
...
#define DEMO_1_SUB_GAIN  DEFAULT_SUB_GAIN
