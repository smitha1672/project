...
//static xBTHandleCommand mFacBTHandleCommand; // David, fix warning.
//static xHMISystemParams mFacSystemParms; // David, fix warning.
...
extern uint8 RFHandler_Paired_Status(void); // David, fix warning.
