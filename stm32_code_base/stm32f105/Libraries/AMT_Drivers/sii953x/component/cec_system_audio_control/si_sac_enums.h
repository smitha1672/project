...
typedef enum
{
...
#if ( configSII_DEV_953x_PORTING == 1 )
    CEC_SAC_TASK_INITIATE_WAIT_TV_RESPONSE      = 0x010,
#else
    ...
    CEC_SAC_TASK_POLLING_STATE_SEND_IARC = 0x50,    
    CEC_SAC_TASK_POLLING_STATE_WAIT_RESPONSE = 0x51,    

    CEC_SAC_TASK_SEND_REPORT_AUDIO_STATUS = 0x60,    
} CecSacTaskState_t;
