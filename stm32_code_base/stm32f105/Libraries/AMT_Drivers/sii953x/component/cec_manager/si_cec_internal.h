...
#define CEC_POLLING_WAITING_TIME_MS     2000   //!< maximum waiting time for acknowledge of the CEC ping
#define CEC_REPORT_AUDIO_STATUS_MIN_MS     50   //!< maximum waiting time for acknowledge of the CEC ping
