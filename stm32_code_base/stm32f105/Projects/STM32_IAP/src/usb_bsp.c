...
// !! extern API is only used on here !!@{
extern void TWI_initialize( void );

extern void GPIOLowLevel_Configuration( void );
...
void BSP_Init(void)
{
    ...
    TWI_initialize(); /*I2C is implmented by smith*/
    SPILowLevel_initialize();
    HT68F30_LightBar_Set(FALSE);

    GPIOMiddleLevel_Set( __O_USB_VBUS );
