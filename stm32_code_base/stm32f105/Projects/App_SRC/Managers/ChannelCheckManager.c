...
typedef enum{
    ...
    CCK_OUTPUT_LEFT_CHANNEL_PINK,
    CCK_OUTPUT_CENTER_CHANNEL,
    CCK_OUTPUT_CENTER_CHANNEL_PINK,
    CCK_OUTPUT_RIGHT_CHANNEL,
    CCK_OUTPUT_RIGHT_CHANNEL_PINK,
    CCK_OUTPUT_RIGHT_REAR_CHANNEL,
    CCK_OUTPUT_RIGHT_REAR_CHANNEL_PINK,  
    CCK_OUTPUT_LEFT_REAR_CHANNEL,
    CCK_OUTPUT_LEFT_REAR_CHANNEL_PINK,
...
static const xCCKNoiseIndexMap mCCKNoiseIndexMap[] = {
    ...
    {CCK_OUTPUT_LEFT_CHANNEL_PINK,CCK_INDEX_W,ROUTE_FL},
    {CCK_OUTPUT_CENTER_CHANNEL,CCK_INDEX_C,ROUTE_CENTER},
    {CCK_OUTPUT_CENTER_CHANNEL_PINK,CCK_INDEX_W,ROUTE_CENTER},    
    {CCK_OUTPUT_RIGHT_CHANNEL,CCK_INDEX_R,ROUTE_FR},
    {CCK_OUTPUT_RIGHT_CHANNEL_PINK,CCK_INDEX_W,ROUTE_FR},
    {CCK_OUTPUT_RIGHT_REAR_CHANNEL,CCK_INDEX_Rs,ROUTE_RR},
    {CCK_OUTPUT_RIGHT_REAR_CHANNEL_PINK,CCK_INDEX_W,ROUTE_RR},  
    {CCK_OUTPUT_LEFT_REAR_CHANNEL,CCK_INDEX_Ls,ROUTE_RL},
    {CCK_OUTPUT_LEFT_REAR_CHANNEL_PINK,CCK_INDEX_W,ROUTE_RL},
...
static void CCKManager_Start(const void * params)
{
    ...
    pADC_ObjCtrl->HardReset();/*Tony150121:BT to CCK will distortion work arround*/
    ...
    for(;;)
    {
        switch(mCCKManagerState)
        {
            ...
            case CCK_END_NOISE:
            {
                ...
                if(pCCK_HMIParams->input_src == AUDIO_SOURCE_BLUETOOTH &&
