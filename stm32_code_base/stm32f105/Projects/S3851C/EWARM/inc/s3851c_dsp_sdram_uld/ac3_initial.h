...
/***********************************************
This file is created by cirrus dsp tool on 12/24/14 19:27:43
This tool was written by XuShoucai on 06/01/09
************************************************/

static const uint32 code AC3_INITIAL_CFG [] = 
{
/* ac3-5.1-TvolOFF_1223.cfg */
// Initial control values
// Created : 
//include ac3-5.1-TvolOFF_1223\system_pcm.cfg
//
// system_pcm (PCM)
//
...
//include ac3-5.1-TvolOFF_1223\cs495314.cfg
//
// cs495314 (CS495314)
//
...
//include ac3-5.1-TvolOFF_1223\decoder_ac3.cfg
//
// decoder_ac3 (AC-3)
//
...
//include ac3-5.1-TvolOFF_1223\mpm_a_crossbar.cfg
//
...
//include ac3-5.1-TvolOFF_1223\tvhdmc_4953X.cfg
//
...
// TVHDMC_VOLUME_NORMALIZER_THRESHOLD : signed : 1.31 format
  0xe0000008, 0x2624dd40, 
// TVHDMC_LKFS_PARAMETER : signed : 1.31 format
  0xe0000009, 0x0a3d70a0, 
...
//include ac3-5.1-TvolOFF_1223\mpm_b_tshd4.cfg
//
// mpm_b_tshd4 (TSHD4)
//
...
//include ac3-5.1-TvolOFF_1223\mpm_b_wow.cfg
//
// mpm_b_wow (WOW HD)
//
...
//include ac3-5.1-TvolOFF_1223\eq_proc.cfg
//
// eq_proc (PEQ)
//
...
//include ac3-5.1-TvolOFF_1223\tone_control_proc.cfg
//
...
//include ac3-5.1-TvolOFF_1223\delay_proc.cfg
//
...
//include ac3-5.1-TvolOFF_1223\gain_multi_channel_plus24.cfg
//
...
// g_1 : signed : 5.27 format
  0xf00000b6, 0x141857af, 
// g_2 : signed : 5.27 format
  0xf00000b7, 0x141857af, 
//
...
//include ac3-5.1-TvolOFF_1223\detector_signal_presence.cfg
//
...
//include ac3-5.1-TvolOFF_1223\filter_highpass_transposed_direct_II.cfg
//
...
//include ac3-5.1-TvolOFF_1223\detector_peak_square.cfg
//
...
//include ac3-5.1-TvolOFF_1223\dynamic_hard_limiter2.cfg
//
...
//
// threshold : signed : 9.23 format
  0xf0000078, 0x02000000, 
// soft_knee : signed : 9.23 format
  0xf0000079, 0x00000000, 
// dsp_ratio : signed : 1.31 format
  0xf000007a, 0x8147ae15, 
// dsp_attack : signed : 1.31 format
  0xf000007b, 0x08414ea2, 
// dsp_release : signed : 1.31 format
  0xf000007c, 0x00fa8a7d, 
// dsp_bypass : signed : 32.0 format
  0xf000007d, 0x00000000, 
//include ac3-5.1-TvolOFF_1223\filter_lowpass_transposed_direct_II.cfg
//
...
//include ac3-5.1-TvolOFF_1223\meter_N_true_peak_and_RMS.cfg
//
...
//include ac3-5.1-TvolOFF_1223\remove_24dB_headroom.cfg
//
// remove_24dB_headroom (24dB Gain)
//
// hold_count : signed : 32.0 format
  0xf000001d, 0x00000bb8, 
//include ac3-5.1-TvolOFF_1223\audio_manager.cfg
//
...
//#define Bytes_of_ac3-5_1-TvolOFF_1023  5192   //(bytes)
