...
/*
                                Smith fix bus: I change task PRIORITY. Side effect is USB audio drops when DC was ON
                                When source is USB, I add 1 second to avoid audio drops.
                          */
        ...
        case USER_EVENT_MODE_DEMO2:
        {
            ...
            else
            {
                ...
                mSystemParams.sys_event = SYS_EVENT_DEV_CONFIG; /*set audio system event*/
                pUDM_ObjCtrl->SendEvent( &mSystemParams ); /*Update vol and mute status*/
                pUDM_ObjCtrl->ExceptionSendEvent(UI_EVENT_ENTER_DEMO2);                       pSDM_ObjCtrl->SendEvent( &mSystemParams );
