#ifndef __AC3_INITIAL_H__
#define __AC3_INITIAL_H__



/***********************************************
This file is created by cirrus dsp tool on 01/03/14 11:34:53
This tool was written by XuShoucai on 06/01/09
************************************************/
static const uint32 code AC3_INITIAL_CFG [] = 
{
/* ac3-5.1-TvolOFF_0715.cfg */
// Initial control values
// Created : 
//include ac3-5.1-TvolOFF_0715\system_pcm.cfg
//
// system_pcm (PCM)
//
...
//include ac3-5.1-TvolOFF_0715\cs495314.cfg
//
// cs495314 (CS495314)
//
...
//include ac3-5.1-TvolOFF_0715\decoder_ac3.cfg
//
// decoder_ac3 (AC-3)
//
...
//include ac3-5.1-TvolOFF_0715\tvhdmc_4953X.cfg
//
...
//include ac3-5.1-TvolOFF_0715\mpm_b_tshd4.cfg
//
// mpm_b_tshd4 (TSHD4)
//
...
//include ac3-5.1-TvolOFF_0715\mpm_b_wow.cfg
//
// mpm_b_wow (WOW HD)
//
...
//include ac3-5.1-TvolOFF_0715\eq_proc.cfg
//
// eq_proc (PEQ)
//
...
//include ac3-5.1-TvolOFF_0715\tone_control_proc.cfg
//
...
//include ac3-5.1-TvolOFF_0715\delay_proc.cfg
//
...
//include ac3-5.1-TvolOFF_0715\gain_multi_channel_plus24.cfg
//
...
// ramp : signed : 1.31 format
  0xf00000bf, 0x00914ff9, 
// g_1 : signed : 5.27 format
  0xf00000c0, 0x7eca9cdc, 
//
...
// g_1 : signed : 5.27 format
  0xf00000b0, 0x327a0168, 
// g_2 : signed : 5.27 format
  0xf00000b1, 0x327a0168, 
//
...
// ramp : signed : 1.31 format
  0xf00000cb, 0x00914ff9, 
// g_1 : signed : 5.27 format
  0xf00000cc, 0x141857af, 
//
// gain_multi_channel_plus24 (Center Gain 2)
//
// hold_count : signed : 32.0 format
  0xf00000c2, 0x00000bb8, 
// ramp : signed : 1.31 format
  0xf00000c3, 0x00914ff9, 
// g_1 : signed : 5.27 format
  0xf00000c4, 0x08000000, 
//
...
// g_1 : signed : 5.27 format
  0xf00000b6, 0x327a0168, 
// g_2 : signed : 5.27 format
  0xf00000b7, 0x327a0168, 
//
...
//include ac3-5.1-TvolOFF_0715\detector_signal_presence.cfg
//
// detector_signal_presence (Presence)
//
// threshold : signed : 1.31 format
  0xf00000c6, 0x00033df4, 
// infinite_hold : signed : 32.0 format
  0xf00000c7, 0x00000000, 
// hold_time : signed : 32.0 format
  0xf00000c8, 0x000005dc, 
//
// detector_signal_presence (Presence)
//
// threshold : signed : 1.31 format
  0xf00000ce, 0x00033df4, 
// infinite_hold : signed : 32.0 format
  0xf00000cf, 0x00000000, 
// hold_time : signed : 32.0 format
  0xf00000d0, 0x000005dc, 
//include ac3-5.1-TvolOFF_0715\filter_highpass_transposed_direct_II.cfg
//
...
// a_1 : signed : 1.31 format
  0xf0000049, 0x7ef029c0, 
// b_1 : signed : 1.31 format
  0xf000004a, 0x7fff6e77, 
// c_1 : signed : 32.0 format
  0xf000004b, 0x00000001, 
// a_2 : signed : 1.31 format
  0xf000004c, 0x00000000, 
// b_2 : signed : 1.31 format
  0xf000004d, 0x7fff6e77, 
// c_2 : signed : 32.0 format
...
// a_1 : signed : 1.31 format
  0xf0000053, 0x7e960d88, 
// b_1 : signed : 1.31 format
  0xf0000054, 0x7ffefd46, 
// c_1 : signed : 32.0 format
  0xf0000055, 0x00000001, 
// a_2 : signed : 1.31 format
  0xf0000056, 0x00000000, 
// b_2 : signed : 1.31 format
  0xf0000057, 0x7ffefd46, 
// c_2 : signed : 32.0 format
...
// a_1 : signed : 1.31 format
  0xf000005d, 0x7ef029c0, 
// b_1 : signed : 1.31 format
  0xf000005e, 0x7fff6e77, 
// c_1 : signed : 32.0 format
  0xf000005f, 0x00000001, 
// a_2 : signed : 1.31 format
  0xf0000060, 0x00000000, 
// b_2 : signed : 1.31 format
  0xf0000061, 0x7fff6e77, 
// c_2 : signed : 32.0 format
...
// a_1 : signed : 1.31 format
  0xf0000067, 0x7ef029c0, 
// b_1 : signed : 1.31 format
  0xf0000068, 0x7fff6e77, 
// c_1 : signed : 32.0 format
  0xf0000069, 0x00000001, 
// a_2 : signed : 1.31 format
  0xf000006a, 0x00000000, 
// b_2 : signed : 1.31 format
  0xf000006b, 0x7fff6e77, 
// c_2 : signed : 32.0 format
  0xf000006c, 0xffffffff, 
//include ac3-5.1-TvolOFF_0715\detector_peak_square.cfg
//
// detector_peak_square (Peak Square Detector)
//
// input_disable_1 : signed : 32.0 format
  0xf00000e1, 0x00000000, 
// tc : signed : 1.31 format
  0xf00000e2, 0x04324349, 
//
// detector_peak_square (Peak Square Detector)
//
// input_disable_1 : signed : 32.0 format
  0xf00000de, 0x00000000, 
// tc : signed : 1.31 format
  0xf00000df, 0x04324349, 
//
// detector_peak_square (Peak Square Detector)
//
// input_disable_1 : signed : 32.0 format
  0xf00000db, 0x00000000, 
// tc : signed : 1.31 format
  0xf00000dc, 0x04324349, 
//
// detector_peak_square (Peak Square Detector)
//
// input_disable_1 : signed : 32.0 format
  0xf00000d5, 0x00000000, 
// tc : signed : 1.31 format
  0xf00000d6, 0x04324349, 
//
// detector_peak_square (Peak Square Detector)
//
// input_disable_1 : signed : 32.0 format
...
// tc : signed : 1.31 format
  0xf00000d9, 0x04324349, 
//
// detector_peak_square (Peak Square Detector)
//
// input_disable_1 : signed : 32.0 format
  0xf00000d2, 0x00000000, 
// tc : signed : 1.31 format
  0xf00000d3, 0x04324349, 
//include ac3-5.1-TvolOFF_0715\dynamic_hard_limiter2.cfg
//
// dynamic_hard_limiter2 (Hard Limiter)
//
// threshold : signed : 9.23 format
  0xf00000a0, 0x07800000, 
...
//include ac3-5.1-TvolOFF_0715\filter_lowpass_transposed_direct_II.cfg
//
...
//include ac3-5.1-TvolOFF_0715\meter_N_true_peak_and_RMS.cfg
//
...
//include ac3-5.1-TvolOFF_0715\remove_24dB_headroom.cfg
//
// remove_24dB_headroom (24dB Gain)
//
// hold_count : signed : 32.0 format
  0xf000001d, 0x00000bb8, 
//include ac3-5.1-TvolOFF_0715\audio_manager.cfg
//
...
//#define Bytes_of_ac3_5_1_TvolOFF  5192   //(bytes)
#endif /*__AC3_INITIAL_H__*/
