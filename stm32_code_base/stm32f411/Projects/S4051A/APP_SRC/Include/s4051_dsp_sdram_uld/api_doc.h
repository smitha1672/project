...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Ls_Rs_Gain_1_1160 0x00a8          /*signed integer*/
#define _ramp_Ls_Rs_Gain_1_1160 0x00a9          /*signed 1.31 format*/
#define _g_0_Ls_Rs_Gain_1_1160 0x00aa          /*signed 5.27 format*/
#define _g_1_Ls_Rs_Gain_1_1160 0x00ab          /*signed 5.27 format*/
#define _clip_0_Ls_Rs_Gain_1_1160 0x00ac          /*READ-ONLY: signed integer*/
#define _clip_1_Ls_Rs_Gain_1_1160 0x00ad          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Ls_Rs_Gain2151 0x00ae          /*signed integer*/
#define _ramp_Ls_Rs_Gain2151 0x00af          /*signed 1.31 format*/
#define _g_0_Ls_Rs_Gain2151 0x00b0          /*signed 5.27 format*/
#define _g_1_Ls_Rs_Gain2151 0x00b1          /*signed 5.27 format*/
#define _clip_0_Ls_Rs_Gain2151 0x00b2          /*READ-ONLY: signed integer*/
#define _clip_1_Ls_Rs_Gain2151 0x00b3          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Ls_Rs_Gain_1119 0x00b4          /*signed integer*/
#define _ramp_Ls_Rs_Gain_1119 0x00b5          /*signed 1.31 format*/
#define _g_0_Ls_Rs_Gain_1119  0x00b6          /*signed 5.27 format*/
#define _g_1_Ls_Rs_Gain_1119 0x00b7          /*signed 5.27 format*/
#define _clip_0_Ls_Rs_Gain_1119 0x00b8          /*READ-ONLY: signed integer*/
#define _clip_1_Ls_Rs_Gain_1119 0x00b9          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_L_R_Gain___24dB_114 0x00ba          /*signed integer*/
#define _ramp_L_R_Gain___24dB_114 0x00bb          /*signed 1.31 format*/
#define _g_0_L_R_Gain___24dB_114 0x00bc          /*signed 5.27 format*/
#define _g_1_L_R_Gain___24dB_114 0x00bd          /*signed 5.27 format*/
#define _clip_0_L_R_Gain___24dB_114 0x00be          /*READ-ONLY: signed integer*/
#define _clip_1_L_R_Gain___24dB_114 0x00bf          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Subwoofer_Gain_1_1161 0x00c0          /*signed integer*/
#define _ramp_Subwoofer_Gain_1_1161 0x00c1          /*signed 1.31 format*/
#define _g_0_Subwoofer_Gain_1_1161 0x00c2          /*signed 5.27 format*/
#define _clip_0_Subwoofer_Gain_1_1161 0x00c3          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Subwoofer_Gain_2132 0x00c4          /*signed integer*/
#define _ramp_Subwoofer_Gain_2132 0x00c5          /*signed 1.31 format*/
#define _g_0_Subwoofer_Gain_2132 0x00c6          /*signed 5.27 format*/
#define _clip_0_Subwoofer_Gain_2132 0x00c7          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Subwoofer_Gain_1120 0x00c8          /*signed integer*/
#define _ramp_Subwoofer_Gain_1120 0x00c9          /*signed 1.31 format*/
#define _g_0_Subwoofer_Gain_1120 0x00ca          /*signed 5.27 format*/
#define _clip_0_Subwoofer_Gain_1120 0x00cb          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Center_Gain_2152 0x00cc          /*signed integer*/
#define _ramp_Center_Gain_2152 0x00cd          /*signed 1.31 format*/
#define _g_0_Center_Gain_2152 0x00ce          /*signed 5.27 format*/
#define _clip_0_Center_Gain_2152 0x00cf          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _threshold_Presence122 0x00d0          /*signed 1.31 format*/
#define _infinite_hold_Presence122 0x00d1          /*signed integer*/
#define _hold_count_Presence122 0x00d2          /*signed integer*/
#define _presence_Presence122 0x00d3          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _hold_count_Center_Gain_1118 0x00d4          /*signed integer*/
#define _ramp_Center_Gain_1118 0x00d5          /*signed 1.31 format*/
#define _g_0_Center_Gain_1118 0x00d6          /*signed 5.27 format*/
#define _clip_0_Center_Gain_1118 0x00d7          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _threshold_Presence73 0x00d8          /*signed 1.31 format*/
#define _infinite_hold_Presence73 0x00d9          /*signed integer*/
#define _hold_count_Presence73 0x00da          /*signed integer*/
#define _presence_Presence73 0x00db          /*READ-ONLY: signed integer*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_SUB_Hard_Limiter106 0x00dc          /*signed integer*/
#define _tc_Peak_Square_Detector_SUB_Hard_Limiter106 0x00dd          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_SUB_Hard_Limiter106 0x00de          /*READ-ONLY: signed 1.31 format*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_RS_Hard_Limiter102 0x00df          /*signed integer*/
#define _tc_Peak_Square_Detector_RS_Hard_Limiter102 0x00e0          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_RS_Hard_Limiter102 0x00e1          /*READ-ONLY: signed 1.31 format*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_LS_Hard_Limiter98 0x00e2          /*signed integer*/
#define _tc_Peak_Square_Detector_LS_Hard_Limiter98 0x00e3          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_LS_Hard_Limiter98 0x00e4          /*READ-ONLY: signed 1.31 format*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_C_Hard_Limiter94 0x00e5          /*signed integer*/
#define _tc_Peak_Square_Detector_C_Hard_Limiter94 0x00e6          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_C_Hard_Limiter94 0x00e7          /*READ-ONLY: signed 1.31 format*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_R_Hard_Limiter90 0x00e8          /*signed integer*/
#define _tc_Peak_Square_Detector_R_Hard_Limiter90 0x00e9          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_R_Hard_Limiter90 0x00ea          /*READ-ONLY: signed 1.31 format*/
...
* 0xHHHH = index. 0xhhhhhhhh = Data Value
*/
#define _disable_0_Peak_Square_Detector_L_Hard_Limiter86 0x00eb          /*signed integer*/
#define _tc_Peak_Square_Detector_L_Hard_Limiter86 0x00ec          /*signed 1.31 format*/
#define _max_peak_Peak_Square_Detector_L_Hard_Limiter86 0x00ed          /*READ-ONLY: signed 1.31 format*/
