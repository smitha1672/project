...
#define DEFAULT_INPUT_SRC    AUDIO_SOURCE_HDMI_IN
#define DEFAULT_MUTE_STATE   SOUND_DEMUTE
#define DEFAULT_MASTER_GAIN  14
#define DEFAULT_BASS_GAIN  6
#define DEFAULT_TREBLE_GAIN  6
#define DEFAULT_SUB_GAIN  6
#define DEFAULT_CENTER_GAIN  6
#define DEFAULT_REAR_GAIN  6
#define DEFAULT_BALANCE  6
...
#define DEMO_1_BASS_GAIN  6
#define DEMO_1_TREBLE_GAIN  6
#define DEMO_1_SUB_GAIN  9
#define DEMO_1_CENTER_GAIN  6
#define DEMO_1_REAR_GAIN  6
#define DEMO_1_BALANCE  6
...
#define SYS_CEC_TASK_PA_CHANGE		0x10	//
#define SYS_CEC_TASK_INIT_SAC               0x20  //
#endif
...
#if ( configSII_DEV_953x_PORTING )
    SYS_EVENT_CEC_SYSTEM_UP,
    SYS_EVENT_ARC_SYSTEM_UP,
    SYS_EVENT_SAC_SYSTEM_UP,
#endif
//----------------FACTORY-----------------//
