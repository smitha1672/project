...
iarbuild %sMODEL%_app.ewp -clean app -log info
iarbuild %sMODEL%_app.ewp -make app -log info

ECHO ******************** B U I L D   %MODEL%  R E L E A S E ********************
iarbuild %sMODEL%_loader.ewp -clean Release -log info
iarbuild %sMODEL%_loader.ewp -make Release -log info
...
copy /b %REL_PATH%\stm32.bin + %REL_PATH%\flash_image_dsp.bin %REL_PATH%\%OUT_FILE%
...
copy /b %REL_PATH%\flash_image_dsp.bin %REL_PATH%\%ONEBIN_PATH%\%OUT_FLASH_V_FILE%
del %REL_PATH%\stm32.bin %REL_PATH%\flash_image_dsp.bin %REL_PATH%\%OUT_SMT_FILE% 
